...
export const styles = sortCx({
    ...
    sizes: {
        sm: {
            root: "gap-1.5 px-2.5 py-1 text-sm not-last:pr-[calc(calc(var(--spacing)*2.5)+0px)] first:rounded-l-lg last:rounded-r-lg data-icon-leading:pl-2 data-icon-only:p-1.5",
            icon: "size-4",
        },
        md: {
