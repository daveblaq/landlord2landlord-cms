...
const sizes = {
    sm: {
        "button-brand": "text-sm font-semibold py-1 px-3",
        "button-gray": "text-sm font-semibold py-1 px-3",
        "button-border": "text-sm font-semibold py-1 px-3",
        "button-minimal": "text-sm font-semibold py-1 px-3",
        underline: "text-sm font-semibold px-1 pb-2.5 pt-0",
        line: "text-sm font-semibold pl-2.5 pr-3 py-0.5",
    },
    md: {
        "button-brand": "text-md font-semibold py-2 px-3",
        "button-gray": "text-md font-semibold py-2 px-3",
        "button-border": "text-md font-semibold py-2 px-3",
        "button-minimal": "text-md font-semibold py-2 px-3",
