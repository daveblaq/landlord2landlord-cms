    ...
    return (
        <div className="relative flex flex-col items-start justify-between gap-4 bg-primary px-4 py-5 md:flex-row md:px-6">
            ...
            <div className="flex flex-wrap items-center gap-3 gap-y-4 max-md:w-full">
                <Button iconLeading={SearchLg} size="sm" color="tertiary" className="order-1 md:hidden" />

                <ButtonGroup selectedKeys={[]} size="sm" className="flex max-md:order-last max-md:min-w-full max-md:flex-1">
