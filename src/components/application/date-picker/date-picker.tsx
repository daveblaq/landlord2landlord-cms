...
export const  DatePicker = ({ value: valueProp, defaultValue, onChange, onApply, onCancel, className, triggerClassName, ...props }: DatePickerProps) => {
    ...
    return (
        <AriaDatePicker
            ...
            {...props}
            className={(values) => cx("w-full flex flex-col gap-1.5", typeof className === "function" ? className(values) : className)}
            value={value}
            onChange={setValue}
        >
