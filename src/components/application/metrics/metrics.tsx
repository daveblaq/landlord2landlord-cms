    ...
    return (
        <div className={cx("rounded-xl bg-primary shadow-xs ring-1 ring-secondary ring-inset", className)}>
            <div className="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
                <FeaturedIcon color="success" theme="light" icon={TrendUp01} size="sm" />
        ...
        <div className={cx("rounded-xl bg-primary shadow-xs ring-1 ring-secondary ring-inset", className)}>
            <div className="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
                <div className="flex items-center gap-3">
                    <FeaturedIcon color="brand" theme="light" size="sm" icon={Zap} />
                    ...
                    <>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex flex-wrap items-center gap-3 lg:gap-4">
                                {/* Skeleton Title */}
                                <div className="h-8 w-24 rounded bg-secondary_hover animate-pulse" />
                                {/* Skeleton Change Trend */}
                                <div className="h-5 w-16 rounded bg-secondary_hover animate-pulse" />
                            </div>
                        </div>
                    </>
                ) : (
                    <>
                        <FeaturedIcon color="gray" theme="modern" icon={icon || TrendUp01} size="sm" />
    ...
    return (
        <div className={cx("min-w-70 rounded-xl bg-primary shadow-xs ring-1 ring-secondary ring-inset", className)}>
            <div className="relative flex flex-col gap-4 px-4 py-5 md:flex-row md:px-5">
                <FeaturedIcon color="gray" theme="modern" icon={icon} size="sm" />
...
export const MetricsChart02 = ({
    ...
    return (
        <div className={cx("rounded-xl bg-primary shadow-xs ring-1 ring-secondary ring-inset", className)}>
            <div className="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
                <div className="flex items-center gap-3">
                    <FeaturedIcon color="gray" theme="modern" size="sm" icon={icon} />
                    <h3 className="text-md font-semibold text-primary">{subtitle}</h3>
                </div>
