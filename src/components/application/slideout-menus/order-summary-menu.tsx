            ...
            <SlideoutMenu isDismissable>
                ...
                <SlideoutMenu.Content>
                    ...
                    <section className="flex flex-col gap-4">
                        <Select size="sm" defaultSelectedKey="express-post" label="Shipping method">
                        ...
                        <span className="flex items-end gap-3">
                            <Input isReadOnly size="sm" defaultValue={discount} onChange={setDiscount} label="Discount code" />
                            <Button color="secondary" size="sm" iconLeading={copied ? Check : Copy07} onClick={() => copy(discount)} />
                        </span>
                    </section>
