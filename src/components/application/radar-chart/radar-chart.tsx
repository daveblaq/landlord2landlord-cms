...
const CustomRadarChartTick = ({ x, y, payload, ...props }: any) => {
    return (
        <text x={x} y={y} textAnchor="middle" {...props} className={cx("recharts-text recharts-polar-radius-axis-tick-value", props.className)}>
